  ...
  return (
    <div className='hero-page-container'>
      <div className='hero-page-selected-hero'>
        ...
        <img
          src={Soldier76.picture}
          className='chosen-hero-img'
          alt={Soldier76.heroName}
        />
          ...
          <ul className='hero-abilities-ul'>
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Soldier76.primaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Soldier76.primaryFire.minDamage,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    ...
                    armor,
                    health,
                    Soldier76.primaryFire.maxDamage,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Soldier76.secondaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Soldier76.secondaryFire.directHitDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    ...
                    armor,
                    health,
                    Soldier76.secondaryFire.minSplashDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    ...
                    armor,
                    health,
                    Soldier76.secondaryFire.maxSplashDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Soldier76.abilityThree.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Soldier76.abilityThree.minDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    ...
                    armor,
                    health,
                    Soldier76.abilityThree.maxDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
