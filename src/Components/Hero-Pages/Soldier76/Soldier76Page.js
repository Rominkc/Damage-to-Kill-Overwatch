                    ...
                    <div className="hero-abilities">
                        ...
                        <ul className="hero-abilities-ul">
                            <li>
                                ...
                                onClick={()=>damageCalculation(Soldier76.primaryFire.name,setAbilitySummary,setArmor,setHealth,armor,health,Soldier76.primaryFire.minDamage,
                                ...
                                onClick={()=>damageCalculation(Soldier76.primaryFire.name,setAbilitySummary,setArmor,setHealth,armor,health,Soldier76.primaryFire.maxDamage,
                                    headShotModifier,discordModifier,nanoBoostAmp,matrixAmp,superchargerAmp,damageBoostAmp)}>
                                    Mx
                                    </button>
                            </li>
                            <li>
                                ...
                                onClick={()=>damageCalculation(Soldier76.secondaryFire.name,setAbilitySummary,setArmor,setHealth,armor,health,Soldier76.secondaryFire.directHitDamage,
                                ...
                                onClick={()=>damageCalculation(Soldier76.secondaryFire.name,setAbilitySummary,setArmor,setHealth,armor,health,Soldier76.secondaryFire.minSplashDamage,
                                    undefined,discordModifier,nanoBoostAmp,matrixAmp,superchargerAmp,damageBoostAmp)}>
                                    SMn
                                    </button>
                                <button data-tip={btnAbilityDescriptions.SMx}
                                onClick={()=>damageCalculation(Soldier76.secondaryFire.name,setAbilitySummary,setArmor,setHealth,armor,health,Soldier76.secondaryFire.maxSplashDamage,
                                    undefined,discordModifier,nanoBoostAmp,matrixAmp,superchargerAmp,damageBoostAmp)}>
                                    SMx
                                    </button>
                            </li>  
                            <li>
                                <button data-tip={btnAbilityDescriptions.Mn}
                                onClick={()=>damageCalculation(Soldier76.abilityThree.name,setAbilitySummary,setArmor,setHealth,armor,health,Soldier76.abilityThree.minDamage,
                                    undefined,discordModifier,nanoBoostAmp,matrixAmp,superchargerAmp,damageBoostAmp)}>
                                    Mn
                                    </button>
                                <button data-tip={btnAbilityDescriptions.Mx}
                                onClick={()=>damageCalculation(Soldier76.abilityThree.name,setAbilitySummary,setArmor,setHealth,armor,health,Soldier76.abilityThree.maxDamage,
                                    undefined,discordModifier,nanoBoostAmp,matrixAmp,superchargerAmp,damageBoostAmp)}>
                                    Mx
                                    </button>
                            </li>
                            <li>
                                ...
                                onClick={()=>damageCalculation('Melee',setAbilitySummary,setArmor,setHealth,armor,health,Soldier76.melee,
