  ...
  return (
    <div className='hero-page-container'>
      <div className='hero-page-selected-hero'>
        ...
        <img
          src={Symmetra.picture}
          className='chosen-hero-img'
          alt={Symmetra.heroName}
        />
          ...
          <ul className='hero-abilities-ul'>
              ...
              <button
                ...
                onClick={() =>
                  damageCalculationBTD(
                    Symmetra.primaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Symmetra.primaryFire.levelOneDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculationBTD(
                    ...
                    armor,
                    health,
                    Symmetra.primaryFire.levelTwoDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculationBTD(
                    ...
                    armor,
                    health,
                    Symmetra.primaryFire.levelThreeDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Symmetra.secondaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Symmetra.secondaryFire.directHitDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    ...
                    armor,
                    health,
                    Symmetra.secondaryFire.minSplashDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    ...
                    armor,
                    health,
                    Symmetra.secondaryFire.maxSplashDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculationBTD(
                    Symmetra.abilityOne.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Symmetra.abilityOne.damage,
                    undefined,
                    discordModifier
                  )
                }
