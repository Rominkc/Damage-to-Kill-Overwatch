          ...
          <ul className='hero-abilities-ul'>
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Hanzo.primaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Hanzo.primaryFire.minDamage,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Hanzo.abilityOne.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Hanzo.abilityOne.minDamage,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Hanzo.abilityTwo.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Hanzo.abilityTwo.damage,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
            ...
            <li>
              <button
                data-tip={btnAbilityDescriptions.Arw}
                onClick={() =>
                  damageCalculation(
                    Hanzo.abilityThree.name + '(Arrow)',
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Hanzo.abilityThree.arrowDamage,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculationDoT(
                    Hanzo.abilityThree.name + '(Dragon)',
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Hanzo.abilityThree.dragonDamage,
                    undefined,
                    discordModifier
                  )
                }
