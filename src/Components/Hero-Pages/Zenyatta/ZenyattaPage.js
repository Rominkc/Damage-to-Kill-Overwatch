                    ...
                    <div className="hero-abilities">
                        ...
                        <ul className="hero-abilities-ul">
                            <li>
                                ...
                                onClick={()=>damageCalculation(Zenyatta.primaryFire.name,setAbilitySummary,setArmor,setHealth,armor,health,Zenyatta.primaryFire.damage,
                            ...
                            <li>
                                <button data-tip={btnAbilityDescriptions.X}
                                onClick={()=>damageCalculation('Melee',setAbilitySummary,setArmor,setHealth,armor,health,Zenyatta.melee,
