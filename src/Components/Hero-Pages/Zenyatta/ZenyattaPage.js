...
const ZenyattaPage =(props)=>{
    const Zenyatta = heroArray[29];
    ...
    return(
            <div className='hero-page-container'>
                <div className='hero-page-selected-hero'>
                    <h1 className='header-dmg2kOW'>{Zenyatta.heroName}</h1>
                    <img src={Zenyatta.picture} className='chosen-hero-img'  alt={Zenyatta.heroName}/>
                    ...
                    <div className="hero-abilities">
                        <ul className="hero-abilities-ul">
                            <li>{Zenyatta.primaryFire.name} :</li>
                            <li>Melee :</li>
                        </ul>
                        <ul className="hero-abilities-ul">
                            <li>
                                <button onClick={()=>damageCalculation(Zenyatta.primaryFire.name,setAbilitySummary,setArmor,setHealth,armor,health,Zenyatta.primaryFire.damage,
                            ...
                            <li>
                                <button onClick={()=>damageCalculation('Melee',setAbilitySummary,setArmor,setHealth,armor,health,Zenyatta.melee,
