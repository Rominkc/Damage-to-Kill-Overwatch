          ...
          <ul className='hero-abilities-ul'>
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Bastion.primaryFireRecon.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Bastion.primaryFireRecon.minDamage,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    ...
                    armor,
                    health,
                    Bastion.primaryFireRecon.maxDamage,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Bastion.primaryFireSentry.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Bastion.primaryFireSentry.minDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    ...
                    armor,
                    health,
                    Bastion.primaryFireSentry.maxDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Bastion.abilityThree.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Bastion.abilityThree.directHitDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
              ...
              <button
                data-tip={btnAbilityDescriptions.S}
                onClick={() =>
                  damageCalculation(
                    Bastion.abilityThree.name,
                    setAbilitySummary,
                    ...
                    armor,
                    health,
                    Bastion.abilityThree.splashDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
