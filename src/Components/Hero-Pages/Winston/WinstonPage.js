      ...
      <div className='hero-page-selected-hero'>
        ...
        <div className='hero-abilities'>
          ...
          <ul className='hero-abilities-ul'>
              ...
              <button
                ...
                onClick={() =>
                  damageCalculationBTD(
                    Winston.primaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Winston.primaryFire.damage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
            ...
            <li>
              <button
                data-tip={btnAbilityDescriptions.Jump}
                onClick={() =>
                  damageCalculation(
                    Winston.abilityOne.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Winston.abilityOne.jumpDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Winston.abilityThree.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Winston.abilityThree.damage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
