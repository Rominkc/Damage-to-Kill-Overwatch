  ...
  return (
    <div className='hero-page-container'>
      <div className='hero-page-selected-hero'>
        ...
        <img
          src={Torbjörn.picture}
          className='chosen-hero-img'
          alt={Torbjörn.heroName}
        />
          ...
          <ul className='hero-abilities-ul'>
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Torbjörn.primaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Torbjörn.primaryFire.damage,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
            ...
            <li>
              <button
                data-tip={btnAbilityDescriptions.DPShMn}
                onClick={() =>
                  damageCalculationDPS(
                    Torbjörn.secondaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Torbjörn.secondaryFire.minDamage,
                    Torbjörn.secondaryFire.pPerShot,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
              ...
              <button
                data-tip={btnAbilityDescriptions.DPShMx}
                onClick={() =>
                  damageCalculationDPS(
                    Torbjörn.secondaryFire.name,
                    setAbilitySummary,
                    ...
                    armor,
                    health,
                    Torbjörn.secondaryFire.maxDamage,
                    Torbjörn.secondaryFire.pPerShot,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Torbjörn.secondaryWeapon.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Torbjörn.secondaryWeapon.damage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculationDPS(
                    Torbjörn.abilityOne.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Torbjörn.abilityOne.damage,
                    Torbjörn.abilityOne.pPerShot,
                    undefined,
                    discordModifier,
                    matrixAmp
                  )
            ...
            <li>
              <button
                data-tip={btnAbilityDescriptions.DPS}
                onClick={() =>
                  damageCalculationTorbUlt(
                    Torbjörn.abilityThree.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Torbjörn.abilityThree.damage,
                    undefined,
                    discordModifier
                  )
                }
