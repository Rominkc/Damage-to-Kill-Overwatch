      ...
      <div className='hero-page-selected-hero'>
        ...
        <div className='hero-abilities'>
          ...
          <ul className='hero-abilities-ul'>
              ...
              <button
                ...
                onClick={() =>
                  damageCalculationDPS(
                    Roadhog.primaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Roadhog.primaryFire.minDamage,
                    Roadhog.primaryFire.pPerShot,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
            ...
            <li>
              <button
                data-tip={btnAbilityDescriptions.PreD}
                onClick={() =>
                  damageCalculation(
                    Roadhog.secondaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Roadhog.secondaryFire.preDetonationDamage,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculationDPS(
                    ...
                    armor,
                    health,
                    Roadhog.secondaryFire.minDamage,
                    Roadhog.secondaryFire.pPerShot,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculationDPS(
                    ...
                    armor,
                    health,
                    Roadhog.secondaryFire.maxDamage,
                    Roadhog.secondaryFire.pPerShot,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Roadhog.abilityOne.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Roadhog.abilityOne.damage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculationDPS(
                    Roadhog.abilityThree.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Roadhog.abilityThree.damage,
                    Roadhog.abilityThree.pPerShot,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
