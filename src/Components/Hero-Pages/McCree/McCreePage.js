          ...
          <ul className='hero-abilities-ul'>
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    McCree.primaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    McCree.primaryFire.minDamage,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    McCree.secondaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    McCree.secondaryFire.minDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    ...
                    armor,
                    health,
                    McCree.secondaryFire.maxDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    McCree.abilityTwo.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    McCree.abilityTwo.damage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
            ...
            <li>
              <button
                data-tip={btnAbilityDescriptions.oneS}
                onClick={() =>
                  damageCalculation(
                    McCree.abilityThree.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    McCree.abilityThree.oneSecDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
              ...
              <button
                data-tip={btnAbilityDescriptions.twoS}
                onClick={() =>
                  damageCalculation(
                    McCree.abilityThree.name,
                    setAbilitySummary,
                    ...
                    armor,
                    health,
                    McCree.abilityThree.twoSecDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
              ...
              <button
                data-tip={btnAbilityDescriptions.threeS}
                onClick={() =>
                  damageCalculation(
                    McCree.abilityThree.name,
                    setAbilitySummary,
                    ...
                    armor,
                    health,
                    McCree.abilityThree.threeSecDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
