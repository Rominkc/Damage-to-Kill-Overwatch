          ...
          <ul className='hero-abilities-ul'>
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    DVa.primaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    DVa.primaryFire.minDamage,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    ...
                    armor,
                    health,
                    DVa.abilityTwo.directHitDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    ...
                    armor,
                    health,
                    DVa.abilityTwo.minSplashDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    ...
                    armor,
                    health,
                    DVa.abilityTwo.maxSplashDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    DVa.abilityThree.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    DVa.abilityThree.minDamage,
                    undefined,
                    discordModifier
                  )
                }
