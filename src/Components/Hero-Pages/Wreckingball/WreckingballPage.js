...
const WreckingballPage = props => {
  const Wreckingball = heroArray[28];
  ...
  return (
    <div className='hero-page-container'>
      <div className='hero-page-selected-hero'>
        ...
        <img
          src={Wreckingball.picture}
          className='chosen-hero-img'
          alt={Wreckingball.heroName}
        />
          ...
          <ul className='hero-abilities-ul'>
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Wreckingball.primaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Wreckingball.primaryFire.minDamage,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    ...
                    armor,
                    health,
                    Wreckingball.primaryFire.maxDamage,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Wreckingball.secondaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Wreckingball.secondaryFire.damage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Wreckingball.abilityOne.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Wreckingball.abilityOne.minDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    ...
                    armor,
                    health,
                    Wreckingball.abilityOne.maxDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Wreckingball.abilityThree.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Wreckingball.abilityThree.damage,
                    undefined,
                    discordModifier
                  )
                }
