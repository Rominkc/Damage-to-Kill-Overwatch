    ...
    return(
            <div className='hero-page-container'>
                <div className='hero-page-selected-hero'>
                    ...
                    <img src={Mercy.picture} className='chosen-hero-img'  alt={Mercy.heroName}/>
                    ...
                    <div className="hero-abilities">
                        ...
                        <ul className="hero-abilities-ul">
                            <li>
                                <button onClick={()=>damageCalculation(Mercy.secondaryFire.name,setAbilitySummary,setArmor,setHealth,armor,health,Mercy.secondaryFire.damage,
                                    headShotModifier,discordModifier,nanoBoostAmp,matrixAmp,superchargerAmp,damageBoostAmp)}>
                                    X
                                    </button>
                            </li>  
                            <li>
                                <button onClick={()=>damageCalculation('Melee',setAbilitySummary,setArmor,setHealth,armor,health,Mercy.melee,
