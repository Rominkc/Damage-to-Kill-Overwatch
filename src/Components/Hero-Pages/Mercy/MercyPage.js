                    ...
                    <div className="hero-abilities">
                        ...
                        <ul className="hero-abilities-ul">
                            <li>
                                ...
                                onClick={()=>damageCalculation(Mercy.secondaryFire.name,setAbilitySummary,setArmor,setHealth,armor,health,Mercy.secondaryFire.damage,
                            ...
                            <li>
                                <button data-tip={btnAbilityDescriptions.X}
                                onClick={()=>damageCalculation('Melee',setAbilitySummary,setArmor,setHealth,armor,health,Mercy.melee,
