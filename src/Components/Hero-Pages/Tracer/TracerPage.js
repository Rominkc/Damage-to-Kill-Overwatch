      ...
      <div className='hero-page-selected-hero'>
        ...
        <div className='hero-abilities'>
          ...
          <ul className='hero-abilities-ul'>
              ...
              <button
                ...
                onClick={() =>
                  damageCalculationDPS(
                    Tracer.primaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Tracer.primaryFire.minDamage,
                    Tracer.primaryFire.pPerShot,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
            ...
            <li>
              <button
                data-tip={btnAbilityDescriptions.Stick}
                onClick={() =>
                  damageCalculation(
                    Tracer.abilityThree.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Tracer.abilityThree.stickDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
