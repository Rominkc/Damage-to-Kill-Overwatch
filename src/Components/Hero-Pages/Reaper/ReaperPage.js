          ...
          <ul className='hero-abilities-ul'>
              ...
              <button
                ...
                onClick={() =>
                  damageCalculationDPS(
                    Reaper.primaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Reaper.primaryFire.minDamage,
                    Reaper.primaryFire.pPerShot,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculationDPS(
                    Reaper.abilityThree.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Reaper.abilityThree.damage,
                    Reaper.abilityThree.pPerSecond,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
