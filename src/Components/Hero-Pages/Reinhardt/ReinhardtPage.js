  ...
  return (
    <div className='hero-page-container'>
      <div className='hero-page-selected-hero'>
        ...
        <img
          src={Reinhardt.picture}
          className='chosen-hero-img'
          alt={Reinhardt.heroName}
        />
          ...
          <ul className='hero-abilities-ul'>
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Reinhardt.primaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Reinhardt.primaryFire.damage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
            ...
            <li>
              <button
                data-tip={btnAbilityDescriptions.B}
                onClick={() =>
                  damageCalculation(
                    Reinhardt.abilityOne.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Reinhardt.abilityOne.bumpDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
              ...
              <button
                data-tip={btnAbilityDescriptions.P}
                onClick={() =>
                  damageCalculation(
                    Reinhardt.abilityOne.name,
                    setAbilitySummary,
                    ...
                    armor,
                    health,
                    Reinhardt.abilityOne.pinDamage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Reinhardt.abilityTwo.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Reinhardt.abilityTwo.damage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Reinhardt.abilityThree.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Reinhardt.abilityThree.damage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
