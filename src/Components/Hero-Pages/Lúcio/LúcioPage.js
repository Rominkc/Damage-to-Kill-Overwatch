      ...
      <div className='hero-page-selected-hero'>
        ...
        <div className='hero-abilities'>
          ...
          <ul className='hero-abilities-ul'>
            <li>
              <button
                data-tip={btnAbilityDescriptions.DPSh}
                onClick={() =>
                  damageCalculationDPS(
                    Lúcio.primaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Lúcio.primaryFire.shotDamage,
                    Lúcio.primaryFire.pPerShot,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
            ...
            <li>
              <button
                ...
                onClick={() =>
                  damageCalculation(
                    Lúcio.secondaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Lúcio.secondaryFire.damage,
                    undefined,
                    discordModifier,
                    nanoBoostAmp,
                    superchargerAmp,
