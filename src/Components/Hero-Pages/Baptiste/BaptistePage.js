  ...
  return (
    <div className='hero-page-container'>
      <div className='hero-page-selected-hero'>
        ...
        <img
          src={Baptiste.picture}
          className='chosen-hero-img'
          alt={Baptiste.heroName}
        />
              ...
              <button
                ...
                onClick={() =>
                  damageCalculationDPS(
                    Baptiste.primaryFire.name,
                    setAbilitySummary,
                    setArmor,
                    setHealth,
                    armor,
                    health,
                    Baptiste.primaryFire.minDamage,
                    Baptiste.primaryFire.pPerShot,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
                    matrixAmp,
              ...
              <button
                ...
                onClick={() =>
                  damageCalculationDPS(
                    ...
                    armor,
                    health,
                    Baptiste.primaryFire.maxDamage,
                    Baptiste.primaryFire.pPerShot,
                    headShotModifier,
                    discordModifier,
                    nanoBoostAmp,
